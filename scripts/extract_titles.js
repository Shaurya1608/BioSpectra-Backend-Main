...
async function run(){
    ...
    const pageRanges=[[1,6],[7,12],[13,16],[17,20],[21,26],[27,30],[31,36],[37,40],[41,42],[43,46],[47,50],[51,54],[55,60],[61,64],[65,68],[69,72],[73,76],[77,80],[81,84],[85,88]];
    let out='';
    ...
    fs.writeFileSync('temp_march_titles.txt', out);
}
run();
